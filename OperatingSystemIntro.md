...
* P2P does not distinguish clients and servers
  ...
  * Node must join P2P network
    ...
    * broadcast request for service and respond to requests for service via **discovery protocol** (广播服务请求并通过**发现协议**响应服务请求。). 
